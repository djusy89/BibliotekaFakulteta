...
<p>
Posalji zahtev za uclanjenje u Biblioteku
<p>
<div id="formDiv" class="formDiv">
<form action="LoginServlet" method="post">
	<fieldset>
		<legend>Podaci o korisniku</legend>
			<input type="hidden" id="<%=IParameter.TIP_LOGINA_PARAM%>" name="<%=IParameter.TIP_LOGINA_PARAM%>" value="<%=IConstant.MOD_PRIJAVA%>">
		...
		<table>
			...
			<tr>
				<td align="right">Telefon<span style="color:red">*</span>:&nbsp;<input type="text" id="telefon" name="telefon" value=""></td>
			</tr>
			<tr>
				<td align="right">E-mail<span style="color:red">*</span>:&nbsp;<input type="text" id="email" name="email" value=""></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="center">Tip korisnika<span style="color:red">*</span>:<br>
				Administrator:<input type="radio" id="administrator" name="tipKorisnika" value="Administrator">
				Bibliotekar:<input type="radio" id="bibliotekar" name="tipKorisnika" value="Bibliotekar">
				Obican korisnik:<input type="radio" id="obicanKorisnik" name="tipKorisnika" value="Obican korisnik" checked="checked">
				</td>
			</tr>
			<tr>
				<td><input type="submit" id="submitDugme" name="submitDugme" value="Posalji zahtev">
			</tr>
		</table>
	</fieldset>
</form>
